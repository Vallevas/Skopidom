-- Migration: 000002_item_details_view.up.sql
-- Creates a view that pre-joins all item relations.
-- All item SELECT queries go through this view — JOIN logic lives here once.
